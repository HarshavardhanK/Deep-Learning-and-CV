...
def get_lines(img, lines, color=[255, 0, 0], thickness=5):
    ...
    return left_lane_slope, left_lane_intercept, right_lane_slope, right_lane_intercept
...
def hough_transform(img, rho, theta, thresh, min_line_len, max_line_gap):
    ...
    if lines is not None:
        left_slope, left_inter, right_slope, right_inter = get_lines(line_img, lines)

    return (line_img, (left_slope, left_inter, right_slope, right_inter))
...
def mark_image(img):
    ...
    (hough_img, (left_slope, left_inter, right_slope, right_inter))  = hough_transform(roi_image, 2, np.pi / 180, 20, 70, 190)

    weighted_image = weighted_img(hough_img, img, alpha=0.9, beta = 1, gamma = 0.)

    return (weighted_image, (left_slope, left_inter, right_slope, right_inter))


if __name__ == '__main__':

    white_output = '/home/tsarshah/Desktop/Code Files/OpenCV/With-Python/challenge.mp4'
    clip = vfc('/home/tsarshah/Desktop/Code Files/OpenCV/With-Python/challenge_video')
